...
namespace ECommerceMVC.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(ShoeContext context)
        {
            _context = context;
        }
        ...
        {
            var ShoeContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await ShoeContext.ToListAsync());
        }
