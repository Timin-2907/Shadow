...
{
    /// <inheritdoc />
    public partial class AddVoucherMapping : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DangKyNhanTin = table.Column<bool>(type: "bit", nullable: false),
                    NewsletterToken = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GiamGia = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MaHdNavigationMaHd = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoucherUsage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VoucherUsage_HoaDon_MaHdNavigationMaHd",
                        column: x => x.MaHdNavigationMaHd,
                        principalTable: "HoaDon",
                        principalColumn: "MaHD",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VoucherUsage_KhachHang_MaKh",
                        column: x => x.MaKh,
                        principalTable: "KhachHang",
                        principalColumn: "MaKH",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VoucherUsage_Voucher_MaVoucher",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VoucherUsage_MaHdNavigationMaHd",
                table: "VoucherUsage",
                column: "MaHdNavigationMaHd");

            migrationBuilder.CreateIndex(
                name: "IX_VoucherUsage_MaKh",
                table: "VoucherUsage",
                column: "MaKh");

            migrationBuilder.CreateIndex(
                name: "IX_VoucherUsage_MaVoucher",
                table: "VoucherUsage",
                column: "MaVoucher");
